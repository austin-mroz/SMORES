...
def _get_predicted_ddG(
    ...
    predicted_ddG = (L_coeff * calculated_L_value) + (B1_coeff * calculated_B1_value) + (B5_coeff * calculated_B5_value)
...
def plot_scatter_stats(
    ...
    plot.set(xlim=(0,1.8))
    fig = plot.get_figure()
    fig.savefig(f"{radii_type}_fit_desymmetrization_results.png")
    fig.clf()
