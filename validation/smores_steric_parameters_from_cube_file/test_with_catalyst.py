...
def main() -> None:
    ...
    _calculate_L(
        cube_data_positions_idx[26],
        cube_data_positions_idx[5],
        streusel_surface,
    )
    _plot_L(cube_data_positions_idx[26],
            cube_data_positions_idx[5],
            streusel_surface,)
...
def _get_command_line_arguments() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        "--input_file",
        type=pathlib.Path,
        default="/Users/austin/Desktop/OngoingResearch/iop_SMORES/catalyst_SMORES_4_publication/3_output/desymmetrization/desymmetrization_reactant_Me/ESP.cube",
    )
    parser.add_argument(
        "-o",
        "--output_file",
